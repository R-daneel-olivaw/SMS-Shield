...
public class Black_SharedredPrefrencesHelper
{
    private static final String PREFS_NAME = "blocked_list_sms_bouncer";
    private static final String MAJOR_KEY = "blocked_list";
    ...
    synchronized static String getBlockedListFromPref(Context context)
    {
    ...
    synchronized static void updatePrefrences(String newData, Context context)
    {
	SharedPreferences settings;
	settings = context.getSharedPreferences(PREFS_NAME, 0);
    ...
    public static synchronized boolean addToBlackList(String newEntry, Context context)
    {
